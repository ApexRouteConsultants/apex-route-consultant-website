      ...
      <section className="relative min-h-screen flex items-center bg-navy-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-20">
          <div className="max-w-4xl animate-fade-in-up">
            ...
            <h1 className="text-2xl md:text-6xl lg:text-5xl font-serif text-white leading-[1.1] mb-8">
            ...
            <p className="text-m text-neutral-300 font-light mb-10 max-w-xl leading-relaxed pl-1 border-l-4 border-gold-500">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link
                to="/contact"
                className="px-6 py-4 bg-gold-500 text-navy-900 font-semibold tracking-widest uppercase hover:bg-white hover:scale-105 transition-all duration-300 text-center rounded-full shadow-lg shadow-gold-500/20"
              >
                Request Consultation
              </Link>
              <Link
                to="/services"
                className="px-5 py-4 border border-white/30 text-white font-medium tracking-widest uppercase hover:bg-white/10 hover:border-white hover:scale-105 transition-all duration-300 text-center rounded-full backdrop-blur-sm"
              >
                View Services
              </Link>
            </div>
